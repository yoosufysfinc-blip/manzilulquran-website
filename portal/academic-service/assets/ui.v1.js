"use strict";
/* Academic Service — ui.v1.js (split from index.html). Immutable: edit a copy as v2. */
/* ==========================================================================
   UI KIT
   ========================================================================== */
...
const FEE_BADGE = { "Paid":"b-ok","Partial":"b-warn","Overdue":"b-bad","Due Today":"b-warn","Upcoming":"b-info",
  "Waived":"b-idle","Nil":"b-idle","Pending":"b-bad" };
...
function withBasis(v){
  if (v.source === "individual") {
    ...
    v.basisText = Logic.feeBasis(v.feeType, st) + " @ " + money(v.rate);
    v.shortBasis = Logic.feeBasis(v.feeType, st);
